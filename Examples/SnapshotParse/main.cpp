...
*/
static std::string valid_fields[NUM_FIELDS] = {"capturetstamp", "framelen", "ingressglobaltstamp", "egressglobaltstamp", "enqqdepth", "deqqdepth"};
...
int main(int argc, char* argv[]){
    ...
    while (reader->getNextPacket(rawPacket))
    {
        ...
        pcpp::Packet parsedPacket(&rawPacket, pcpp::SNAPSHOT); // SNAPSHOT -> parse until this layer only                                                
        pcpp::SnapshotLayer* sslayer = parsedPacket.getLayerOfType<pcpp::SnapshotLayer>();
        ...
        // Extract the snapshot parameters
