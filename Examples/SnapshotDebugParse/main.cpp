...
void printUsage(FILE *fout) {
    fprintf(fout, "\nUsage:\n"
            ...
            "                      List of fields:\n"
            "                      payloadingressglobaltstamp (48-bit ns)\n"
            "                      payloadegressglobaltstamp (48-bit ns)\n"
            "                      payloadenqqdepth (cells)\n"
            "                      payloaddeqqdepth (cells)\n"
            "                      origegressglobaltimestamp (48-bit ns)\n"
            "                      newegressglobaltimestamp (48-bit ns)\n"
            "                      newenqtimestamp (32-bit ns, but only 18 bits valid)\n"
            "                      framelen (bytes)\n"
            "                      capturetstamp (s.us)\n"
